...
export const getDogData = async () => {
  try {
    const response = await fetch("https://api.thedogapi.com/v1/images/search?size=med&limit=15&has_breeds=1", requestOptions);
...
export const getDogDataById = async (id) => {
  const response = await fetch(`https://api.thedogapi.com/v1/breeds/${id}`, requestOptions)
